            ...
            try {
                ...
                if (existingRoutines == null || existingRoutines.isEmpty()) {
                    ...
                    for (Routine r : existingRoutines) {
                        Log.d(TAG, "  Existing routine: ID: " + r.getRoutineId() + ", Name: " + r.getRoutineName() + 
                              ", Tasks: " + r.getTasks().size());
                    }
                }
            } catch (Exception e) {
